...
export function initMap ({ location }) {
     ...
     * Distance
     */
    let distanceUrl = 'https://maps.googleapis.com/maps/api/distancematrix/json?origins='
    let url = `${distanceUrl}${location.lat},${location.lng}&destinations=${fixedLocations[0].lat},${fixedLocations[0].lng}`
